...
<!-- <a class="dropdown-toggle" role="button" aria-expanded="false" aria-haspopup="true" data-toggle="dropdown"> -->
				<ul class="nav navbar-nav">
					<li><a href="LinkAction?index=<%= "1000" %>"><i class="icon-home icon-white"></i>首页</a></li>
					<li><a href="LinkAction?index=<%= "1005" %>"><i class="icon-cog icon-white"></i>考试操作</a></li>
					...
					<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="LinkAction?index=<%= "1008" %>"><i class="icon-list"></i>学生信息</a></li>
